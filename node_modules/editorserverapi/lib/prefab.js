...
Prefab.prototype.routing = function() {
	...
	this.app.get(this.root + '/' + Prefab.KEY, function(req, res) {
		instance.read(req, res);
	});

	this.app.post(this.root + '/' + Prefab.KEY, function(req, res) {
		instance.create(req, res);
	});
};

/**
* read a prefab on the server
*
* @method read
* @param {Request} http request
* @param {Response} http response
*/
Prefab.prototype.read = function(_req, _res) {
...
/**
* Create a prefab on the server
*
* @method create
* @param {Request} http request
* @param {Response} http response
*/
Prefab.prototype.create = function(_req, _res) {
	_res.setHeader('content-type', 'text/plain');
	_res.statusCode = 500;
